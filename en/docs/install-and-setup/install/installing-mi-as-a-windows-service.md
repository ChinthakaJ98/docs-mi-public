...
-	Go to the [WSO2 Integrator: MI Downloads page](https://wso2.com/products/downloads/?product=wso2integrator&package=other-options&profile=mi) and download the product distribution as a ZIP file.
