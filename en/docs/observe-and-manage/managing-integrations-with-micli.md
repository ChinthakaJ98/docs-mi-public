...
1.  Download **MI CLI** based on your preferred platform (i.e., Mac, Windows, Linux).
    ...
    - [For Mac with Intel Chip](https://github.com/wso2/product-mi-tooling/releases/download/v4.7.0/mi-4.7.0-darwin-amd64.tar.gz)
    - [For Mac with Apple Silicon](https://github.com/wso2/product-mi-tooling/releases/download/v4.7.0/mi-4.7.0-darwin-arm64.tar.gz)
    - [For Linux 32-bit](https://github.com/wso2/product-mi-tooling/releases/download/v4.7.0/mi-4.7.0-linux-i586.tar.gz)
    - [For Linux 64-bit with AMD processor](https://github.com/wso2/product-mi-tooling/releases/download/v4.7.0/mi-4.7.0-linux-amd64.tar.gz)
    - [For Linux 64-bit with ARM processor](https://github.com/wso2/product-mi-tooling/releases/download/v4.7.0/mi-4.7.0-linux-arm64.tar.gz)
    - [For Windows 32-bit](https://github.com/wso2/product-mi-tooling/releases/download/v4.7.0/mi.exe-4.7.0-windows-i586.zip)
    - [For Windows 64-bit](https://github.com/wso2/product-mi-tooling/releases/download/v4.7.0/mi.exe-4.7.0-windows-x64.zip)
...
1.  Make sure that the WSO2 Integrator: MI (WSO2 MI) 4.7.0 version is started and that the 4.7.0 version of MI CLI is set up.     
